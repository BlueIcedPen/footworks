<?php $__env->startSection('content'); ?>
                ...
                <ul class="slides">
                    <li>
                        ...
                        <p class="flex-caption">
                            <span class="main" >Join Footworks Today</span>
                            <br />
                            <span class="secondary clearfix" >Join the Footworks Team today and bless lives</span>
                        </p>
                    </li>
                    <li>
                        <img src="<?php echo e(asset ('images/slides/slide-2.jpg')); ?>"  alt="" />
                        <p class="flex-caption">
                            <span class="main" >Give, go!</span>
                            <br />
                            <span class="secondary clearfix" >blah blah blah</span>
                        </p>
                    </li>
                </ul><!--//slides-->
            </div><!--//flexslider-->
            <section class="promo box box-dark">        
                <div class="col-md-9">
                <h1 class="section-heading">Why Footworks Training?</h1>
            ...
            <section class="news">
                <h1 class="section-heading text-highlight"><span class="line">Messages</span></h1>     
                        ...
                        <div class="carousel-inner">
                            <div class="item active"> 
                                <div class="col-md-10 news-item">
                                    ...
                                    <p>Soup Kitchen is an event that is organized to provide free medical care, food and clothing among others feeds to thousands of needy, orphans and street children and less privileged in society. Every year since 2009, thousands of needy and less privileged people; orphans, 
                                       street children, drug addicts, kayayei in Ghana and other African countries have benefited from Soup Kitchen.</p>
            ...
            <div class="row cols-wrapper">
                ...
                <div class="col-md-3">
                    <section class="links">
                        ...
                        <div class="section-content">
                            <p><a href="#"><i class="fa fa-caret-right"></i>Have your National serve with Footworks</a></p>
                            <p><a href="#"><i class="fa fa-caret-right"></i>Serve as an intern during your vacation</a></p>
                            <p><a href="#"><i class="fa fa-caret-right"></i>Volunteer for short term missions</a></p>
                            <p><a href="#"><i class="fa fa-caret-right"></i>Take a 6 (six) break for missions</a></p>
                        </div><!--//section-content-->
                    </section><!--//links-->
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <blockquote class="quote">                                  
                                            <p><i class="fa fa-quote-left"></i>Missions is the heartbeat of God. Ministry is about souls. Footworks is a place of expression of your ministry. Recognize whatever God has deposited in you, whatever He’s done in your, and do so to others.</p>
                                        </blockquote>                
                                        <div class="row">
                                            <p class="people col-md-8 col-sm-3 col-xs-8"><span class="name">Rev Dr. Victor Osei</span><br /><span class="title">General Overseer<br/>Family Chapel International</span></p>
                                            <img class="profile col-md-4 pull-right" src="assets/images/testimonials/profile-1.png"  alt="" />
                                        </div>                               
                                    </div><!--//item-->
                                    <div class="item">
                                        <blockquote class="quote">
                                            <p><i class="fa fa-quote-left"></i>Footworks International is a great and wonderful ministry that is directly fulfilling the call of God to send the Gospel to the ends of the earth. I love the ministry and believe we can do a lot together.</p>
                                        </blockquote>
                                        <div class="row">
                                            <p class="people col-md-8 col-sm-3 col-xs-8"><span class="name">Rev Dr. Kwabena Darko</span><br /><span class="title">CEO<br/>Darko Farms</span></p>
                                            <img class="profile col-md-4 pull-right" src="assets/images/testimonials/profile-2.png"  alt="" />
                                        </div>                 
                                    </div><!--//item-->
                                    <div class="item">
                                        <blockquote class="quote">
                                            <p><i class="fa fa-quote-left"></i>In our lifetime, wouldn't it be sad if we spent more time washing dishes or swatting flies or mowing the yard or watching television than praying for world missions?</p>
                                        </blockquote>
                                        <div class="row">
                                            <p class="people col-md-8 col-sm-3 col-xs-8"><span class="name">Dave Davidson</span><br /><span class="title"></span></p>
